...
updateol: .build-artefacts/ol3 .build-artefacts/ol-requirements-installation.timestamp
	...
	cd .build-artefacts/ol3; git checkout master; git fetch origin; git checkout interaction-hint; git merge --ff origin/interaction-hint; git show; cp ../../scripts/ga-ol3.exports src/ol/ga-ol3.exports; ../python-venv/bin/python build.py $(addprefix build/,$(OL_JS))
...
.build-artefacts/ol3:
	git clone https://github.com/elemoine/ol3.git $@
